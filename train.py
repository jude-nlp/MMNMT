...
from src.trainer import SingleTrainer, EncDecTrainer, XlmEncDecTrainer
from src.evaluation.evaluator import SingleEvaluator, EncDecEvaluator, XlmEncDecEvaluator
...
def get_parser():
    ...
    parser.add_argument("--lambda_bt", type=str, default="1",
                        help="BT coefficient")
    parser.add_argument("--lambda_disc", type=int, default="1",
                        help="BT coefficient")  # update
    ...
    parser.add_argument("--disc_step", type=bool_flag, default=False,
                        help="discriminator")                    

    # update add noise to MT 8-11
    parser.add_argument("--MT_noise", type=bool_flag, default=False,
                        help="MT_noise")
    ...
    # update 8-11 为了保证预训练和翻译过程中的 lang_id 一致
    parser.add_argument("--eval_mt_steps", type=str, default="",
                        help="Eval Machine translation steps")
    # update 8-21 获取模型每一层的相似度

...
class TransformerModel(nn.Module):
    ...
    def fwd(self, x, lengths, causal, xlm_output=None, src_enc=None, src_len=None, positions=None, langs=None, cache=None):
        """
        Inputs:

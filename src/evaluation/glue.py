...
class GLUE:
    ...
    def run(self, task):
        ...
        for epoch in range(params.n_epochs):
            ...
            # save checkpoint
            logger.info("Save checkpoint to %s" % params.dump_path) # Update
            self.save_checkpoint('checkpoint', include_optimizers=False) # Update
    ...
    def load_data(self, task):
        ...
        self.n_sent = 1 if task in ['SST-2', 'CoLA', 'discriminator'] else 2
...
#            'best_stopping_criterion': self.best_stopping_criterion,
        ...
        data[name] = self.embedder.model.state_dict()
